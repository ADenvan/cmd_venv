...
- **Frontend**: HTML5, CSS3, Vanilla JavaScript, HTMX, Alpine.js
...
7. **Agent Interface** — Contracts between backend and frontend agents
...
- **Default**: Django Templates + HTMX for interactivity + Alpine.js for local state.
